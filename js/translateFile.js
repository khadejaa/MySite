...
arrLang['en']['resume'] = 'My Resume';
arrLang['en']['edu'] = 'Education';
arrLang['en']['exp'] = 'Volunteer Experiences';
arrLang['en']['skills'] = 'Skills';
arrLang['en']['awards'] = 'Awards';
arrLang['en']['services'] = 'My Services';
...
arrLang['en']['myName'] = 'Khadejaa'
arrLang['en']['myRole'] = 'MSc Computer Science Student, Full Stack Developer, EV3 Robot trainer, Blogger And More'

// //Arabic home section
arrLang['ar']['greating'] = 'مرحبا ، أنا '
arrLang['ar']['myName'] = 'خديجة بنت سعد'
arrLang['ar']['myRole'] = 'طالبة ماجستير بعلوم الحاسب الآلي ، مطورة مواقع ، مدربة روبوتات ، مٌدونة وأكثر '
...
//Education section
arrLang['en']['education'] = 'Education'

arrLang['en']['BachelorDate'] = '2013-2017'
...
arrLang['en']['FEWDdate'] = '2018'
arrLang['en']['FEWD'] = 'Front-End Web Developer Nanodegree'
arrLang['en']['Udacity'] = 'Udacity'

arrLang['en']['iOSdate'] = '2019'
arrLang['en']['iOS'] = 'iOS Developer Nanodegree Program'
arrLang['en']['Udacity'] = 'Udacity'


//Arabic resume section
//Education section
...
arrLang['en']['SEU'] = 'SEU Leader'
arrLang['en']['College'] = 'College Of Computers And Information Systems'

arrLang['en']['coffeeDate'] = '2016-2017'
arrLang['en']['coffee'] = "a Member Then Leader of 'After The Coffee' Reading Club"
arrLang['en']['Rushd'] = 'Rushd Club In Um Al-Qraa University'
...
//English awards section
arrLang['en']['Awards'] = 'Awards'

arrLang['en']['LeaderDate'] = '2016'
arrLang['en']['leaders'] = 'Top 5 Best leaders'
arrLang['en']['leadersProgram'] = 'Be Leader Program'

arrLang['en']['medalDate'] = '2019'
arrLang['en']['medal'] = 'The Second Medal In EOSS| Research Track'
arrLang['en']['FCIT'] = 'Faculty of Computing and Information Technology | KAU'

//Arabic awards section
...
arrLang['ar']['medal'] = 'الميدالية الثانية في مسار الأبحاث العلمية'
arrLang['ar']['FCIT'] = 'كلية الحاسبات ونظم المعلومات بجامعة الملك عبدالعزيز'
...
arrLang['en']['EV3'] = 'EV3 Robot Training'
arrLang['en']['EV3Description'] = 'Do you want to learn how to programing ev3 robot ? I can help you.'
...
//ِEnglish My Last Achievements section
arrLang['en']['Achievements'] = 'My Last Achievements'
arrLang['en']['quotes'] = 'Who you are tomorrow begins with what you do today. – Tim Fargo'

arrLang['en']['iosCertificate'] = 'Certificate of iOS Nanodegree'
arrLang['en']['self'] = 'Self Learnin'

arrLang['en']['fog'] = 'Above The Fog'
arrLang['en']['fogDescription'] = 'Digital Sketch, One of my favorite digital drawings.'

arrLang['en']['cs'] = 'CS Student Projects'
arrLang['en']['csDescription'] = 'Web Design, Web-based system for FCIT of King Abdulaziz University Students that collecting there projects in one place'

arrLang['en']['ML'] = 'Certificate of Machine Learning Course'
arrLang['en']['self'] = 'Self Learning'

arrLang['en']['reading'] = 'Reading Workshop'
...
arrLang['ar']['fog'] = 'فوق الضباب'
arrLang['ar']['fogDescription'] = 'رسم الكتروني ، واحدة من رسماتي المفضلة'

arrLang['ar']['cs'] = 'مشاريع طلبة علوم الحاسب الآلي'
arrLang['ar']['csDescription'] = 'تصميم المواقع، موقع لجمع مشاريع طلاب وطالبات علوم الحاسب الآلي بجامعة الملك عبدالعزيز'
...
arrLang['en']['30days'] = '30 Days without social media'
...
arrLang['en']['sara'] = 'Sarah Al-Shareef, Ph.D.'
...
arrLang['ar']['asPart'] = 'جزء من التوصية العلمية'
arrLang['ar']['clickhere'] = 'انقر هنا لقراءة التوصية كامله'
